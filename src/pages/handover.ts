  ...
  <div class="document-body">
    ...
    <section id="delivery-operations">
      ...
      <h3>관리자에서 할 수 있는 것</h3><ul>
        ...
        <li><strong>언론보도</strong> — 인터뷰·기고 기사의 날짜·매체·제목·요약·원문 링크를 등록하면 <a href="/press">/press</a> 목록과 원장 소개의 ‘언론 활동’에 자동 반영됩니다.</li>
      ...
      <aside class="callout"><p class="title">언론보도 올리는 법</p><p><a href="/admin/press">관리자 → 언론보도 → 새 보도</a> → 보도일·매체명·기사 제목·2~3줄 요약·원문 링크를 입력하고 <strong>‘공개’ 체크 → 저장</strong>합니다.</p><p>기사 본문은 저작권 때문에 올리지 않고 요약과 링크만 게시합니다. 등록한 항목은 <a href="/press">언론보도 페이지</a>와 <a href="/doctors/han-hwirim#press">원장 소개의 ‘언론 활동’</a>에 최신순으로 표시되며, 검색엔진·AI용 구조화 데이터(NewsArticle)도 함께 생성됩니다.</p></aside>
