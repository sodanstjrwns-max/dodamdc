...
- 공통 공개 본문: 진료 설명·백과사전·칼럼/공지 본문·개인정보 안내의 `.prose`를 모바일 16px/PC 17px, 행간 1.9, 최대 문장 폭 44rem으로 정리했습니다. 핵심 요약과 설명의 크기/굵기를 구분하고 소제목·문단·목록 간격을 개선했습니다. FAQ, 의료진 이야기, 장비/약속 카드도 읽기 쉽게 조정했습니다. 자동 문장 재작성이나 숨김, 전체 CMS 저장 데이터 변환은 하지 않습니다.
